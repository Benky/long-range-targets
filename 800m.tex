...
\newcommand{\circleDistance}{75mm}
\newcommand{\circleTen}{88.5mm}
\newcommand{\baseOffset}{50mm}
\newcommand{\xLength}{15mm}
...
\begin{tikzpicture}
  \begin{scope}[shift={(210mm,300mm)}]
    ...
    \node[scale=\smallFont, color=white] at (0mm, 70mm) {\large \textbf{10}};
